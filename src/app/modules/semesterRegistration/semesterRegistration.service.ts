...
const getAllFromDB = async (
  ...
  if (searchTerm) {
    andConditions.push({
      OR: semesterRegistrationSearchableFields.map((field: any) => ({
        [field]: {
          contains: searchTerm,
          mode: 'insensitive',
        },
...
const startNewSemester = async (id: string) => {
  ...
  await prisma.$transaction(async prismaTransactionClient => {
    ...
    const studentSemesterRegistations =
    ...
    asyncForEach(
      ...
      async (studentSemReg: StudentSemesterRegistration) => {
        const studentSemeseterRegistrationCourses =
        ...
        console.log(studentSemeseterRegistrationCourses);
      }
    );
  });
